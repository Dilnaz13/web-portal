...
const lakes = ref<Lake[]>([
  { name:'Озеро Пёстрое', lat: 54.836674, lng: 69.109874, level: 1.7},
  { name:'Озеро Белое', lat: 55.035607, lng: 70.194716, level: 1.3},
  { name:'Озеро Горькое', lat: 54.948484, lng: 68.950702, level: 1.25},
  { name:'Озеро Поганка', lat: 54.921344, lng: 69.052130, level: 1.7},
  { name:'Озеро Дикое', lat: 54.840156, lng: 69.131957, level: 1.77},
  { name:'Озеро Полковниково', lat: 55.172774, lng: 69.249948, level: 1.03},
  { name:'Озеро Никульское', lat: 55.263029, lng: 69.357153, level: 1.2},
])
</script>
